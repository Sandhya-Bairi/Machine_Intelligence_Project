...
#determine the polarity of each tweet. from the feature vector generated for each tweet, compare if the elements of the feature vector exists in the corpus
