...
class TwitterData(object):
    ...
    def __init__(self):
        ...
        consumer_key = 'DmdF89kbKZvhk4fD3LJFeazkF'
        consumer_secret = 'kk6bPX4vQoA9DzoxT0tUsZ5tRzfmF6f4YPl1NTTgkyejO3Ya4r'
        access_token = '3478783633-EhJYWQNFl53VyHjsl33HsHXDoTM38WDL1uVUYag'
        access_token_secret = 'fqdRaCbDYBmS8a1jQYusDeQpPLKVd0CVJIpV1InOHRbez'
    ...
    # set sentiment using textblob sentiment method
...
def main():
    ...
    hashtag = raw_input('Enter a key word for which tweets are to be obtained: ')
    ...
    print("Results: ")
    print("\n")
    print(tabulate(lis_tweets,tablefmt="rst"))
    #print("\n---------------------------------------\n")
